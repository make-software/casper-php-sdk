...
class BlockHeaderJsonSerializer extends JsonSerializer
{
    /**
    ...
    public static function toJson($blockHeader): array
    {
        return array(
            ...
            'era_end' => $blockHeader->getEraEnd() ? EraEndJsonSerializer::toJson($blockHeader->getEraEnd()) : null,
    ...
    public static function fromJson(array $json): BlockHeader
    {
        return new BlockHeader(
            ...
            isset($json['era_end']) ? EraEndJsonSerializer::fromJson($json['era_end']) : null,
