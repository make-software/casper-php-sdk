...
class DeployExecutableJsonSerializer extends JsonSerializer
{
    /**
    ...
    public static function toJson($deployExecutable): array
    {
        if ($deployExecutable->isModuleBytes()) {
            $result['ModuleBytes'] = array(
                ...
                'args' => DeployNamedArgJsonSerializer::toJsonArray(
    ...
    public static function fromJson(array $json): DeployExecutable
    {
        ...
        foreach ($json as $key => $data) {
            ...
            foreach ($data['args'] as $arg) {
                $executableInternalInstance->setArg(DeployNamedArgJsonSerializer::fromJson($arg));
            }
        }
